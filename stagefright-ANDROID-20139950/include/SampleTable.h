...
public:
    ...
    status_t setSampleToChunkParams2(off64_t data_offset, size_t data_size);
    ...
    status_t setTimeToSampleParams2(off64_t data_offset, size_t data_size);
    status_t setTimeToSampleParamsMTK(off64_t data_offset, size_t data_size, uint32_t);

    status_t setCompositionTimeToSampleParams(
            off64_t data_offset, size_t data_size);
    status_t setCompositionTimeToSampleParams2(
            off64_t data_offset, size_t data_size);
    status_t setCompositionTimeToSampleParamsMTK(
            off64_t data_offset, size_t data_size, uint32_t);

    status_t setSyncSampleParams(off64_t data_offset, size_t data_size);
    status_t setSyncSampleParams2(off64_t data_offset, size_t data_size);
